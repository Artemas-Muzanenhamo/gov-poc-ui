...
describe('EditLicenseComponent', () => {
  ...
  const LICENSE = {
    ...
    surname: 'Muzanenhamo',
    firstNames: 'Artemas',
    dateOfBirth: moment('28/03/1990', 'DD/MM/YYYY').toDate().toLocaleDateString(),
    country: 'Zimbabwe',
    dateOfIssue: moment('28/03/1990', 'DD/MM/YYYY').toDate().toLocaleDateString(),
    expiryDate: moment('28/03/1990', 'DD/MM/YYYY').toDate().toLocaleDateString(),
    agency: 'DVLA',
